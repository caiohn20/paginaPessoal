...
<head>
    ...
    <title>Caio Henrique Natal</title>
    ...
    <header>
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid py-2 px-4">
                <a class="navbar-brand fs-4 fw-bold" href="#">Caio Henrique Natal</a>
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerHeader">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link hoverAzul" href="#">Sobre Mim</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link hoverAzul" href="#">Contato</a>
                        </li>
                    </ul>
                </div>
            </div>
